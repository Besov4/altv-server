...
import mysql from 'mysql2/promise';  // Используем ES-модуль для работы с MySQL
...
// Функция для отправки сообщений игроку
...
async function registerPlayer(username, email, password, discordId, rockstarId) {
    try {
        ...
        alt.log('Регистрация успешна для пользователя: ' + username);
        return { success: true };
    } catch (error) {
...
// Экспортируем необходимые функции для работы с чатом
